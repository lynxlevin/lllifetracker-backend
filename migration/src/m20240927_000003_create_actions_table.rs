        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(timestamp_with_time_zone(Action::CreatedAt).default(Expr::current_timestamp()))
                    .col(timestamp_with_time_zone(Action::UpdatedAt).default(Expr::current_timestamp()))
                    .foreign_key(
                        ForeignKey::create()
